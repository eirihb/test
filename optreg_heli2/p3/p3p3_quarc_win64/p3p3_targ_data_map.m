  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% p3p3_P.elavation_offsetdeg_Value
	  ...
	  ;% p3p3_P.Integrator_UpperSat
	  section.data(23).logicalSrcIdx = 99;
	  section.data(23).dtTransOffset = 22;
	
	  ;% p3p3_P.Integrator_LowerSat
	  section.data(24).logicalSrcIdx = 100;
	  section.data(24).dtTransOffset = 23;
	
	  ;% p3p3_P.elevation_ref_Value
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% p3p3_DW.uWorkspace_PWORK.TimePtr
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% p3p3_DW.xWorkspace1_PWORK.TimePtr
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% p3p3_DW.Vd_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% p3p3_DW.Vs_PWORK.LoggedData
	  ...
	  ;% p3p3_DW.PtichrateScopedegs1_PWORK.LoggedData
	  ...
	  ;% p3p3_DW.Backmotor_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% p3p3_DW.Frontmotor_PWORK.LoggedData
	  ...
	  ;% p3p3_DW.Optimalu_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 29;
	  section.data(15).dtTransOffset = 14;
	
	  ;% p3p3_DW.Optimalx_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 30;
	  section.data(16).dtTransOffset = 15;
	
	  ;% p3p3_DW.Realu_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 31;
	  section.data(17).dtTransOffset = 16;
	
	  ;% p3p3_DW.Realx_PWORK.LoggedData
	  ...
	  ;% p3p3_DW.uWorkspace_IWORK.PrevIndex
	  section.data(1).logicalSrcIdx = 42;
	  section.data(1).dtTransOffset = 0;
	
	  ;% p3p3_DW.xWorkspace1_IWORK.PrevIndex
	  section.data(2).logicalSrcIdx = 43;
	  section.data(2).dtTransOffset = 1;
  ...
  targMap.checksum0 = 3773984117;
  targMap.checksum1 = 212135506;
  targMap.checksum2 = 746962065;
  targMap.checksum3 = 3360806124;
