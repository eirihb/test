...
typedef struct {
  ...
  real_T TimeFigure_TimeBuffer[1000];  /* '<Root>/Time Figure' */
  real_T TimeFigure_DataBuffer[1000];  /* '<Root>/Time Figure' */
  ...
  real_T TimeFigure_RWORK[2];          /* '<Root>/Time Figure' */
  struct {
    void *LoggedData;
  ...
  int_T TimeFigure_IWORK[3];           /* '<Root>/Time Figure' */
...
struct P_helicopter_T_ {
  ...
  real_T XYFigure_maximum_x;           /* Mask Parameter: XYFigure_maximum_x
                                        ...
                                        */
  real_T TimeFigure_maximum_y;         /* Mask Parameter: TimeFigure_maximum_y
  ...
  real_T XYFigure_minimum_x;           /* Mask Parameter: XYFigure_minimum_x
                                        * Referenced by: '<Root>/XY Figure'
                                        */
  real_T TimeFigure_minimum_y;         /* Mask Parameter: TimeFigure_minimum_y
                                        * Referenced by: '<Root>/Time Figure'
                                        */
  ...
  real_T HILInitialize_set_other_outpu_j;/* Mask Parameter: HILInitialize_set_other_outpu_j
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T TimeFigure_update_rate;       /* Mask Parameter: TimeFigure_update_rate
                                        * Referenced by: '<Root>/Time Figure'
                                        */
  ...
  boolean_T HILReadEncoderTimebase_Active;/* Computed Parameter: HILReadEncoderTimebase_Active
                                           * Referenced by: '<S4>/HIL Read Encoder Timebase'
                                           */
  boolean_T TimeFigure_RelativeTime;   /* Computed Parameter: TimeFigure_RelativeTime
                                        * Referenced by: '<Root>/Time Figure'
                                        */
