...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (323014959U);
  helicopter_M->Sizes.checksums[1] = (1765899304U);
  helicopter_M->Sizes.checksums[2] = (3691192961U);
  helicopter_M->Sizes.checksums[3] = (3051117615U);
...

  {
    int32_T i;
    for (i = 0; i < 1000; i++) {
      helicopter_DW.TimeFigure_TimeBuffer[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 1000; i++) {
      helicopter_DW.TimeFigure_DataBuffer[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 1000; i++) {
      helicopter_DW.XYFigure_XBuffer[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 1000; i++) {
      helicopter_DW.XYFigure_YBuffer[i] = 0.0;
    }
  }
  ...
  helicopter_DW.TimeFigure_RWORK[0] = 0.0;
  helicopter_DW.TimeFigure_RWORK[1] = 0.0;
