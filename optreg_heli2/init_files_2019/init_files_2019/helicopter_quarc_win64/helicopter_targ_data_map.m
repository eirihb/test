  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_P.XYFigure_maximum_x
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_P.TimeFigure_maximum_y
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_P.XYFigure_maximum_y
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_P.XYFigure_minimum_x
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_P.TimeFigure_minimum_y
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_P.XYFigure_minimum_y
	  ...
	  ;% helicopter_P.TimeFigure_update_rate
	  ...
	  ;% helicopter_P.XYFigure_update_rate
	  ...
	  ;% helicopter_P.TimeFigure_RelativeTime
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.TimeFigure_TimeBuffer
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 64;
	
	  ;% helicopter_DW.TimeFigure_DataBuffer
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 1064;
	
	  ;% helicopter_DW.XYFigure_XBuffer
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 2064;
	
	  ;% helicopter_DW.XYFigure_YBuffer
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 3064;
	
	  ;% helicopter_DW.TimeStampA
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 4064;
	
	  ;% helicopter_DW.LastUAtTimeA
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 4065;
	
	  ;% helicopter_DW.TimeStampB
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 4066;
	
	  ;% helicopter_DW.LastUAtTimeB
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 4067;
	
	  ;% helicopter_DW.HILWriteAnalog_Buffer
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 4068;
	  ...
	  ;% helicopter_DW.TimeFigure_RWORK
	  ...
	  ;% helicopter_DW.TimeFigure_IWORK
	  section.data(1).logicalSrcIdx = 43;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_DW.XYFigure_IWORK
  ...
  targMap.checksum0 = 323014959;
  targMap.checksum1 = 1765899304;
  targMap.checksum2 = 3691192961;
  targMap.checksum3 = 3051117615;
