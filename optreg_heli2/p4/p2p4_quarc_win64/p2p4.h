...
#ifndef RTW_HEADER_p2p4_h_
#define RTW_HEADER_p2p4_h_
#include <math.h>
#include <string.h>
#ifndef p2p4_COMMON_INCLUDES_
# define p2p4_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* p2p4_COMMON_INCLUDES_ */

#include "p2p4_types.h"
...
#define p2p4_rtModel                   RT_MODEL_p2p4_T

/* Block signals (auto storage) */
typedef struct {
  real_T uWorkspace;                   /* '<Root>/u Workspace' */
  real_T xWorkspace1[4];               /* '<Root>/x Workspace1' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Optimalx_PWORK;                    /* '<Root>/Optimalx ' */

  struct {
    void *LoggedData;
  } Realx_PWORK;                       /* '<Root>/Realx' */

  struct {
    void *LoggedData;
  } Realx1_PWORK;                      /* '<Root>/Realx1' */
...
#define rtB                            p2p4_B
#define BlockIO                        B_p2p4_T
#define rtX                            p2p4_X
#define ContinuousStates               X_p2p4_T
#define rtXdot                         p2p4_XDot
#define StateDerivatives               XDot_p2p4_T
#define tXdis                          p2p4_XDis
#define StateDisabled                  XDis_p2p4_T
#define rtP                            p2p4_P
#define Parameters                     P_p2p4_T
#define rtDWork                        p2p4_DW
#define D_Work                         DW_p2p4_T
...
extern P_p2p4_T p2p4_P;

/* Block signals (auto storage) */
extern B_p2p4_T p2p4_B;

/* Continuous states (auto storage) */
extern X_p2p4_T p2p4_X;

/* Block states (auto storage) */
extern DW_p2p4_T p2p4_DW;

/* Model entry point functions */
extern void p2p4_initialize(void);
extern void p2p4_output(void);
extern void p2p4_update(void);
extern void p2p4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern p2p4_rtModel *p2p4(void);
...
extern RT_MODEL_p2p4_T *const p2p4_M;
 ...
 * '<Root>' : 'p2p4'
 * '<S1>'   : 'p2p4/Conversion'
 * '<S2>'   : 'p2p4/Degrees to Radians'
 * '<S3>'   : 'p2p4/Elevation controller'
 * '<S4>'   : 'p2p4/Helicopter_interface'
 * '<S5>'   : 'p2p4/Pitch controller'
 * '<S6>'   : 'p2p4/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'p2p4/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'p2p4/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'p2p4/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'p2p4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'p2p4/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'p2p4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_p2p4_h_ */
