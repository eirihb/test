...
MODEL                = p4p4Without_feedback
MODULES              = p4p4Without_feedback_data.c p4p4Without_feedback_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = p4p4Without_feedback.mk
...
MODELLIB                  = p4p4Without_feedbacklib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = p4p4Without_feedback_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\eirihb\Desktop\optreg_heli2\p4
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\p4p4Without_feedback_quarc_win64
