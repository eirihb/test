...
#ifndef RTW_HEADER_p4p4Without_feedback_h_
#define RTW_HEADER_p4p4Without_feedback_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef p4p4Without_feedback_COMMON_INCLUDES_
# define p4p4Without_feedback_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* p4p4Without_feedback_COMMON_INCLUDES_ */

#include "p4p4Without_feedback_types.h"
...
#define p4p4Without_feedback_rtModel   RT_MODEL_p4p4Without_feedback_T

/* Block signals (auto storage) */
typedef struct {
  real_T uWorkspace[2];                /* '<Root>/u Workspace' */
  ...
  real_T xWorkspace1[6];               /* '<Root>/x Workspace1' */
  real_T Sum5;                         /* '<Root>/Sum5' */
  real_T TmpSignalConversionAtToFileInpo[12];
} B_p4p4Without_feedback_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Optimalu_PWORK;                    /* '<S5>/Optimalu' */

  struct {
    void *LoggedData;
  } Realu_PWORK;                       /* '<S5>/Realu' */

  struct {
    void *FilePtr;
  } ToFile1_PWORK;                     /* '<S5>/To File1' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } xWorkspace1_PWORK;                 /* '<Root>/x Workspace1' */

  struct {
    void *LoggedData;
  } Combined_PWORK;                    /* '<S5>/Combined' */

  struct {
    void *LoggedData;
  } Optimalx_PWORK;                    /* '<S5>/Optimalx ' */

  struct {
    void *LoggedData;
  } Realx_PWORK;                       /* '<S5>/Realx' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile1_IWORK;                     /* '<S5>/To File1' */

  struct {
    int_T PrevIndex;
  } xWorkspace1_IWORK;                 /* '<Root>/x Workspace1' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S5>/To File' */
} DW_p4p4Without_feedback_T;
...
#define rtB                            p4p4Without_feedback_B
#define BlockIO                        B_p4p4Without_feedback_T
#define rtX                            p4p4Without_feedback_X
#define ContinuousStates               X_p4p4Without_feedback_T
#define rtXdot                         p4p4Without_feedback_XDot
#define StateDerivatives               XDot_p4p4Without_feedback_T
#define tXdis                          p4p4Without_feedback_XDis
#define StateDisabled                  XDis_p4p4Without_feedback_T
#define rtP                            p4p4Without_feedback_P
#define Parameters                     P_p4p4Without_feedback_T
#define rtDWork                        p4p4Without_feedback_DW
#define D_Work                         DW_p4p4Without_feedback_T

/* Parameters (auto storage) */
struct P_p4p4Without_feedback_T_ {
...
struct tag_RTM_p4p4Without_feedback_T {
  const char_T *path;
...
extern P_p4p4Without_feedback_T p4p4Without_feedback_P;

/* Block signals (auto storage) */
extern B_p4p4Without_feedback_T p4p4Without_feedback_B;

/* Continuous states (auto storage) */
extern X_p4p4Without_feedback_T p4p4Without_feedback_X;

/* Block states (auto storage) */
extern DW_p4p4Without_feedback_T p4p4Without_feedback_DW;

/* Model entry point functions */
extern void p4p4Without_feedback_initialize(void);
extern void p4p4Without_feedback_output(void);
extern void p4p4Without_feedback_update(void);
extern void p4p4Without_feedback_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern p4p4Without_feedback_rtModel *p4p4Without_feedback(void);
...
extern RT_MODEL_p4p4Without_feedback_T *const p4p4Without_feedback_M;
 ...
 *
 * '<Root>' : 'p4p4Without_feedback'
 * '<S1>'   : 'p4p4Without_feedback/Conversion'
 * '<S2>'   : 'p4p4Without_feedback/Degrees to Radians'
 * '<S3>'   : 'p4p4Without_feedback/Elevation controller'
 * '<S4>'   : 'p4p4Without_feedback/Helicopter_interface'
 * '<S5>'   : 'p4p4Without_feedback/LQR'
 * '<S6>'   : 'p4p4Without_feedback/Pitch controller'
 * '<S7>'   : 'p4p4Without_feedback/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'p4p4Without_feedback/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'p4p4Without_feedback/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'p4p4Without_feedback/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'p4p4Without_feedback/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'p4p4Without_feedback/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'p4p4Without_feedback/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_p4p4Without_feedback_h_ */
