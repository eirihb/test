...
MODEL                = p4p4With_feedback
MODULES              = p4p4With_feedback_data.c p4p4With_feedback_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = p4p4With_feedback.mk
...
MODELLIB                  = p4p4With_feedbacklib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = p4p4With_feedback_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\p4p4With_feedback_quarc_win64
