...
#ifndef RTW_HEADER_p4p4_h_
#define RTW_HEADER_p4p4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef p4p4_COMMON_INCLUDES_
# define p4p4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* p4p4_COMMON_INCLUDES_ */

#include "p4p4_types.h"
...
#define p4p4_rtModel                   RT_MODEL_p4p4_T
...
#define rtB                            p4p4_B
#define BlockIO                        B_p4p4_T
#define rtX                            p4p4_X
#define ContinuousStates               X_p4p4_T
#define rtXdot                         p4p4_XDot
#define StateDerivatives               XDot_p4p4_T
#define tXdis                          p4p4_XDis
#define StateDisabled                  XDis_p4p4_T
#define rtP                            p4p4_P
#define Parameters                     P_p4p4_T
#define rtDWork                        p4p4_DW
#define D_Work                         DW_p4p4_T
...
extern P_p4p4_T p4p4_P;

/* Block signals (auto storage) */
extern B_p4p4_T p4p4_B;

/* Continuous states (auto storage) */
extern X_p4p4_T p4p4_X;

/* Block states (auto storage) */
extern DW_p4p4_T p4p4_DW;

/* Model entry point functions */
extern void p4p4_initialize(void);
extern void p4p4_output(void);
extern void p4p4_update(void);
extern void p4p4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern p4p4_rtModel *p4p4(void);
...
extern RT_MODEL_p4p4_T *const p4p4_M;
 ...
 * '<Root>' : 'p4p4'
 * '<S1>'   : 'p4p4/Conversion'
 * '<S2>'   : 'p4p4/Degrees to Radians'
 * '<S3>'   : 'p4p4/Elevation controller'
 * '<S4>'   : 'p4p4/Helicopter_interface'
 * '<S5>'   : 'p4p4/LQR'
 * '<S6>'   : 'p4p4/Pitch controller'
 * '<S7>'   : 'p4p4/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'p4p4/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'p4p4/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'p4p4/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'p4p4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'p4p4/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'p4p4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_p4p4_h_ */
